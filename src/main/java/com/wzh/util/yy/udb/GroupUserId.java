...
public class GroupUserId {
    ...
    public static void main(String[] args) throws IOException {
        BufferedReader br = new BufferedReader(new InputStreamReader(new FileInputStream(new File("F:\\密码-me号数据\\Hujiao_USER_BL_ID.csv")), "UTF-8"));//构造一个BufferedReader类来读取文件
        Integer lineCount = 1;
